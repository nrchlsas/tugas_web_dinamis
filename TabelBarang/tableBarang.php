...
$query = mysqli_query($mysql, "SELECT * FROM barang ORDER BY id_barang ASC");
?>
...
<body class="d-flex flex-column h-100">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="nav navbar-nav navbar-left mb-2 mb-lg-0">
                    ...
                    <li class="glyphicon">
                    <li><a href="tableBarang.php"><span class="glyphicon glyphicon-list-alt"></span>Tabel Barang</a></li>
                    </li>
                </ul>
                    ...
                    <tbody>
                        ...
                        if (mysqli_num_rows($query) == 0) {
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                echo "<td>" . $data['harga'] * $data['stok'] . "</td>";

                        ?>
                                <td>
                                    <a href="" class="edit" data-toggle="modal" data-target="#modal<?php echo $data['id_barang']; ?>"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <div class="modal fade" id="modal<?php echo $data['id_barang']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form action="tableBarangUpdate_Proses.php" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Harga</label>
                                                            <input type="text" name="harga" class="form-control" value="<?php echo $data['harga']; ?>" required></input>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Stok</label>
                                    ...
                                    <a href="" class="delete" data-toggle="modal" data-target="#modalD<?php echo $data['id_barang']; ?>"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                    <div class="modal fade" id="modalD<?php echo $data['id_barang']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form action="tableBarangDelete_Proses.php" method="DELETE" name="id_barang">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Delete Barang</h4>
                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <p>Are you sure you want to delete these Records? <?php echo $data['id_barang']; ?></p>
                                                        <p class="text-warning"><small>This action cannot be undone.</small></p>
                                                        <div class="form-group">
                                                            <label>Id Pembeli</label>
                                                            <input type="text" name="id_barang" class="form-control" value="<?php echo $data['id_pembeli']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
    ...
    <div id="addEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="tableBarangProses.php" method="POST">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Id Barang</label>
                            <input type="text" name="id_pembeli" class="form-control" id="id_barang">
                        </div>
                        <div class="form-group">
                            <label>Nama Barang</label>
                        ...
                        <div class="form-group">
                            <label>Harga</label>
                            <input type="text" name="harga" class="form-control" id="harga" required></input>
                        </div>
                        <div class="form-group">
                            <label>Stok</label>
